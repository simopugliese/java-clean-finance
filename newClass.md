...
The requirements analysis focuses on building a personal finance management system that goes beyond basic CRUD operations, enforcing domain-specific invariants and strict transactional integrity.
...
participant Wallet as Wallet
    ...
    Note over Cmd,Wallet: Esempio di ripristino per transazione
    Cmd->>Repo: getWalletByUUID(walletId)
    activate Repo
    Repo-->>Cmd: Optional<Wallet>
    deactivate Repo
